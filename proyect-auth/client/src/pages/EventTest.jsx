    ...
    return (
        <div className="p-4 space-y-6 max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-6">
                <h2 className="text-xl font-bold text-slate-800 mb-2">🧪 Test de Creación de Eventos</h2>
                ...
                <button
                    ...
                    className="mb-4 px-4 py-2 bg-purple-100 text-purple-700 rounded-xl text-sm font-medium hover:bg-purple-200"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 disabled:opacity-50"
                    >
                        {status === 'loading' ? (
                            <>
            ...
            <div className="bg-slate-900 rounded-2xl p-6 text-white">
                ...
                {!requestPayload && !status && (
                    <p className="text-slate-500 text-sm">Envía un evento para ver la información de debug aquí.</p>
                )}
            </div>
        </div>
    )
